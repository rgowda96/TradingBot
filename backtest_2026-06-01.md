...
**Run:** 2026-06-01 05:54 UTC  |  **Micro range simulated:** $100000K – $5000.0M
...
| Metric | Value |
|--------|-------|
| Total tokens analysed | 1 |
| Catchable (non-meme) | 1 |
| Had early signal before 3x | 0/1 (0%) |
| Meme tokens (fundamentals won't catch) | 0 |
| Data errors (CoinGecko unavailable) | 0 |
...
| | |
|--|--|
| ATH MCap | $1,897,964,607 |
| ATH date | 2025-07-23 |
| Overall mult (in 365d window) | 1.2x |
| In micro range | 2025-06-02 → 2026-06-01 (366d) |

**Signals fired in micro range:** 5 total

| Signal type | Count | Hit rate (≥3x ATH) | Median 7d return | Median 30d return | Avg days to ATH |
|-------------|-------|--------------------|------------------|-------------------|-----------------|
| Sleeping giant | 1 | 0/1 (0%) | 0.9x | 0.9x | 5d |
| Breakout | 4 | 0/4 (0%) | 1.1x | 1.1x | 2d |
...
### Sleeping Giant  (5× vs 30d quiet baseline)
| | |
|--|--|
| Total signals across all catchable tokens | 1 |
| Led to ≥3x from signal (hit rate) | 0/1 (0%) |
| Led to ≥10x from signal | 0/1 (0%) |
| Median 7d peak return | 0.9x |
| Median 30d peak return | 0.9x |
| Avg days to ATH from signal | 5d |
| Best single signal → ATH | 0.9x |

### Resistance Breakout  (new 30d high +5%)
| | |
|--|--|
| Total signals across all catchable tokens | 4 |
| Led to ≥3x from signal (hit rate) | 0/4 (0%) |
| Led to ≥10x from signal | 0/4 (0%) |
| Median 7d peak return | 1.1x |
| Median 30d peak return | 1.1x |
| Avg days to ATH from signal | 2d |
| Best single signal → ATH | 1.2x |
...
---
*Generated by backtest.py — 2026-06-01 05:54 UTC*